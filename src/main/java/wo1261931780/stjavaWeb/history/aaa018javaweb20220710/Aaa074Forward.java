...
@WebServlet(name = "Aaa074Forward", value = "/Aaa074Forward")
public class Aaa074Forward extends HttpServlet {
	@Override
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// request.setCharacterEncoding("UTF-8");
		LOG_SHOW.debug("开始转发");
		// request.getRequestDispatcher("/Aaa075Forward").forward(request, response);
		// 直接设置要转发的目的地就可以
