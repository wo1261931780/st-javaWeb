...
/**
 * 交易节点操作时长参数信息表(宁波项目测试表-后续会主动删除)(TasParamTranoptime)表数据库访问层
 *
 * @author makejava
...
public interface TasParamTranoptimeDao {
	 ...
	 * @return 对象列表
	 */
	// List<TasParamTranoptime> queryAllByLimit(TasParamTranoptime tasParamTranoptime, @Param("pageable") Pageable pageable);
	 ...
	 *
	 * @param entities List<TasParamTranoptime> 实例对象列表
	 * @return 影响行数
	 */
