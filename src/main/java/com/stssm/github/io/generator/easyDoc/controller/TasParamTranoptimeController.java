...
/**
 * 交易节点操作时长参数信息表(宁波项目测试表-后续会主动删除)(TasParamTranoptime)表控制层
 *
 * @author makejava
...
public class TasParamTranoptimeController {
	 ...
	 */
	// @GetMapping
	// public ResponseEntity<Page<TasParamTranoptime>> queryByPage(TasParamTranoptime tasParamTranoptime, PageRequest pageRequest) {
