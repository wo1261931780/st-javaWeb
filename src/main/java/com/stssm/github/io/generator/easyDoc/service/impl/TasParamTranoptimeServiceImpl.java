...
/**
 * 交易节点操作时长参数信息表(宁波项目测试表-后续会主动删除)(TasParamTranoptime)表服务实现类
 *
 * @author makejava
...
public class TasParamTranoptimeServiceImpl implements TasParamTranoptimeService {
	 ...
	 */
	// @Override
	// public Page<TasParamTranoptime> queryByPage(TasParamTranoptime tasParamTranoptime, PageRequest pageRequest) {
