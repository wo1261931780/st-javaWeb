package com.stssm.github.io.javaweb.aaa021JAVAWEB2022年7月13日.web; /**
...
@WebServlet("/aaa085servlet")
public class aaa085servlet extends HttpServlet {
	@Override
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/aaa004.jsp").forward(request, response);
