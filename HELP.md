...
* The following dependencies are not known to work with Spring Native: 'Spring Configuration Processor, Spring Boot DevTools, GCP Support'. As a result, your application may not work as expected.
...
```
$ docker run --rm -p 8080:8080 junw_st_project:0.0.1-SNAPSHOT
```
